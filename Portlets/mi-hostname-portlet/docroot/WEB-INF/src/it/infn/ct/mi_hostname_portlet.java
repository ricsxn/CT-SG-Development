    ...
    */
    ...
    void submitJob(AppInput appInput, PortalInfo portalInfo) {
        ...
        if(infrastructuresInfo.length > 0) {            
            ...
            // Job details
            String executable="/bin/sh";                          // Application executable (bash/sh)
            String arguments  = appPreferences.getPilotScript()   // executable' arguments: (pilot_script)
            ...
            String inputSandbox=appServerPath+"WEB-INF/job/"      //
                           ...
                           +","+PortalInfoScript                  // PortalInfo.sh script (full path)
