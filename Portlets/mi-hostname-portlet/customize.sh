...
# lcg-infosites --vo eumed wms
#
INI_2_WMSHOST='wms://wms014.cnaf.infn.it:7443/glite_wms_wmproxy_server'
...
# Create the appropriate build.xml file
cat > build.xml <<EOF
<?xml version="1.0"?>

<project name="${PORTLET_NAME}" basedir="." default="deploy">
